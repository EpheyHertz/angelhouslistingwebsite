...
export default function Footer() {
  ...
  const handleSubscribe = (e) => {
    ...
    toast.success('Subribed Successfully,Thank You',{
      duration:3000,
    })
    setEmail('')
  };
    ...
    <footer className="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div className="space-y-6">
                <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-400 tracking-wider uppercase animate-fade-in-down">
                  Company
                </h3>
          ...
          <div className="mt-8 xl:mt-0 space-y-6 animate-fade-in-up">
      ...
      >
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 animate-fade-in">
