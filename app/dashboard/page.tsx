    ...
    return (
      <Layout title="Authentication Required | House Listing Platform">
        <div className="flex flex-col items-center justify-center h-screen">
          ...
          <Link href="/auth/login" className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
            Login
          </Link>
        </div>
      </Layout>
  ...
  if (!user) {
    return (
      <Layout title="Error | House Listing Platform">
        <div className="flex justify-center items-center h-screen">
          <p className="text-red-500 text-xl">Error loading user data. Please try again later.</p>
        </div>
      </Layout>
    )
  }
  ...
  return (
    <Layout title="Dashboard | House Listing Platform">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Welcome, {user.full_name}</h1>
