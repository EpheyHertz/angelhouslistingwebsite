...
import { addReview, getReviews } from '../../server-action/review-actions'
import ReviewsAndComments from '../../../components/review-component'
import { useAuth } from '../../../hooks/hooks'
import EditHouseDetails from '../../../components/updateHouse'
import { updateUserHousesById } from '../../server-action/house_actions'
...
export default function HouseDetails() {
  ...
  return (
    <Layout title={`${house.title} | House Listing Platform`}>
      <motion.div
